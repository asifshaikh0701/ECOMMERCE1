...
// //   return (
// //     <div className="relative min-h-screen py-10 px-6 bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 overflow-hidden">
// //       {/* Pastel background shapes */}
// //       <div className="absolute top-10 left-10 w-72 h-72 bg-pink-200 rounded-full blur-3xl opacity-30"></div>
// //       <div className="absolute bottom-20 right-20 w-80 h-80 bg-green-200 rounded-full blur-3xl opacity-30"></div>
// //       <div className="absolute top-1/3 right-1/3 w-64 h-64 bg-yellow-200 rounded-full blur-3xl opacity-30"></div>

// //       <h1 className="relative z-10 text-4xl font-extrabold text-pink-700 mb-10 text-center drop-shadow-md">
// //         💖 Your Wishlist
// //       </h1>
...
// //           <motion.div
// //             key={product._id}
// //             className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-lg overflow-hidden border border-white/40 hover:shadow-2xl transition-all flex flex-col"
...
// //               <h2 className="text-lg font-bold text-gray-800 truncate mb-4">{product.name}</h2>
...
//   return (
//     <div className="relative min-h-screen py-10 px-6 bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 overflow-hidden">
//       {/* Animated Gradient Blobs */}
//       <motion.div
//         className="absolute top-0 left-0 w-72 h-72 bg-gradient-to-tr from-green-400 to-blue-300 rounded-full opacity-40 blur-3xl"
//         animate={{ x: [0, 50, 0], y: [0, 30, 0] }}
//         transition={{ duration: 10, repeat: Infinity, repeatType: "mirror" }}
//       />
//       <motion.div
//         className="absolute bottom-10 right-0 w-80 h-80 bg-gradient-to-br from-purple-300 to-blue-400 rounded-full opacity-40 blur-3xl"
//         animate={{ x: [0, -60, 0], y: [0, -40, 0] }}
//         transition={{ duration: 12, repeat: Infinity, repeatType: "mirror" }}
//       />
//       <motion.div
//         className="absolute top-1/3 right-1/3 w-64 h-64 bg-gradient-to-l from-green-200 to-purple-200 rounded-full opacity-40 blur-3xl"
