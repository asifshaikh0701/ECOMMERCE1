...
// import { FaEnvelope, FaPhone, FaEdit, FaSave, FaSignOutAlt } from "react-icons/fa";
...
//   if (!user) {
//     return (
//       <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#F0FDF4] to-[#C7EFCF]">
...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F0FDF4] to-[#C7EFCF] px-4 py-10">
//       <div className="bg-white rounded-3xl shadow-[0_0_30px_#3B7A57aa] p-8 md:p-12 w-full max-w-md text-center transition-transform duration-300 hover:scale-[1.02] border-4 border-transparent hover:border-green-600">
...
//             className="text-center text-2xl font-bold text-green-800 border-b-2 border-green-300 w-full mb-2 outline-none"
//           />
//         ) : (
//           <h2 className="text-3xl font-bold text-[#3B7A57] mb-1">{user.name}</h2>
//         )}
