...
//   // 🔹 NEW FUNCTION: Buy Now (direct to checkout)
//   const handleBuyNow = () => {
//     if (!user?._id) {
...
//     const cartItem = {
//       productId: product, // passing full product object
//       quantity: 1,
//     };
...
//         {/* Product Image */}
//         <motion.div
//           className="rounded-2xl overflow-hidden shadow-md border border-gray-200 mt-12"
